    ...
    <form action={formAction} className="flex flex-col gap-4">
      <div>
        ...
        {state?.fieldErrors?.username && (
          <p className={errClass}>{state.fieldErrors.username[0]}</p>
        )}
      </div>
      ...
      <div>
        ...
        {state?.fieldErrors?.email && <p className={errClass}>{state.fieldErrors.email[0]}</p>}
      </div>
      ...
      <div>
        <label htmlFor="bio" className="text-sm font-medium">
          Hakkında <span className="text-neutral-400 dark:text-neutral-500">(opsiyonel)</span>
        </label>
        <textarea id="bio" name="bio" rows={2} className={fieldClass} />
        {state?.fieldErrors?.bio && <p className={errClass}>{state.fieldErrors.bio[0]}</p>}
      </div>
